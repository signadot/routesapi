...
type RoutesClient interface {
	// GetWorkloadRoutes returns a set of workload routing rules, each
	// of which indicates how to direct requests destined to a given
	// baseline workload with a given routing key.
	GetWorkloadRoutes(ctx context.Context, in *WorkloadRoutesRequest, opts ...grpc.CallOption) (*GetRoutesResponse, error)
	// WatchWorkloadRoutes provides a stream of diff operations which operate
	// on a set of workload routing rules to maintain the routing rules
	// in near real time with in-cluster Sandboxes and RouteGroups.
